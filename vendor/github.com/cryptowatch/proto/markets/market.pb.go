...
type MarketUpdateMessage struct {
	...
	//	*MarketUpdateMessage_TickerUpdate
...
type MarketUpdateMessage_TickerUpdate struct {
	TickerUpdate *TickerUpdate `protobuf:"bytes,1,opt,name=tickerUpdate,oneof"`
}
...
func (*MarketUpdateMessage_TickerUpdate) isMarketUpdateMessage_Update()         {}
...
func (m *MarketUpdateMessage) GetTickerUpdate() *TickerUpdate {
	if x, ok := m.GetUpdate().(*MarketUpdateMessage_TickerUpdate); ok {
...
func (*MarketUpdateMessage) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _MarketUpdateMessage_OneofMarshaler, _MarketUpdateMessage_OneofUnmarshaler, _MarketUpdateMessage_OneofSizer, []interface{}{
		(*MarketUpdateMessage_TickerUpdate)(nil),
...
func _MarketUpdateMessage_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *MarketUpdateMessage_TickerUpdate:
...
func _MarketUpdateMessage_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*MarketUpdateMessage)
	switch tag {
	case 1: // Update.tickerUpdate
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TickerUpdate)
		err := b.DecodeMessage(msg)
		m.Update = &MarketUpdateMessage_TickerUpdate{msg}
		return true, err
...
type TickerUpdate struct {
	Market *Market `protobuf:"bytes,1,opt,name=market" json:"market,omitempty"`
...
func (*TickerUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }

func (m *TickerUpdate) GetMarket() *Market {
	if m != nil {
		return m.Market
	}
	return nil
...
func (m *TickerUpdate) GetPrice() float32 {
	if m != nil {
		return m.Price
	}
	return 0
...
func (*OrderBookUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*OrderBookDeltaUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*SpreadHistoryUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
var fileDescriptor0 = []byte{
	...
	,
}
